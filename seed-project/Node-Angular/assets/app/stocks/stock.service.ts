...
import { StockObject, Info, Stock, Return, Valuation, P_E, P_S, P_FCF, TA, Strat, Profitability, BalanceSheet } from "./models/stock.model";
                    ...
                    transformedStocks.push(
                        new StockObject(
                            ...
                            new Profitability (
                                ...
                                stock.Profitability.GrossMargin,
                                stock.Profitability.EBITMargin,
                                stock.Profitability.NetMargin,
                                stock.Profitability.ROE,
                                stock.Profitability.CurrentRatio,
                                stock.Profitability.DividendRatio
                            ),
                            new BalanceSheet (
                                stock.BalanceSheet.DebtPerShare,
                                stock.BalanceSheet.EquityPerShare
                            )
                        )
                    );
                }
