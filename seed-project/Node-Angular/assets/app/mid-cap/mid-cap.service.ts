...
import { StockObject, Info, ReportDate, Stock, Return, Valuation, P_E, P_S, P_FCF, TA, Strat, Profitability } from "./mid-cap-stock.model";
...
export class MidCapService {
    ...
    getStocks() {
        return this.http.get('http://localhost:3000/stocks_midcap')
