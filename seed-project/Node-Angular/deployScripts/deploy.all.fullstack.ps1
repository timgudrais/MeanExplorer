...
Invoke-Expression 'cmd /c start powershell.exe -nologo -noexit -command { Invoke-Expression C:\Users\sun\Desktop\DevTest\MeanExplorer\seed-project\Node-Angular\deployScripts\deploy.mongodb.backend.ps1 }'
